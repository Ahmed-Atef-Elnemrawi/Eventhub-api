...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EventHub.EventManagement.Domain.Entities.EventEntities.EventAttendant", b =>
                {
                    b.Property<Guid>("EventId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasKey("EventId", "AttendantId");

                    b.HasIndex("AttendantId");

                    b.ToTable("EventsAttendants", (string)null);
                });
            ...
            modelBuilder.Entity("EventHub.EventManagement.Domain.Entities.UserPage", b =>
                {
                    b.Property<Guid>("UserPageId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "3aa21ec8-a3b5-4710-8b71-563b0c67b637",
                            Name = "Manager",
                            NormalizedName = "MANAGER"
                        },
                        new
                        {
                            Id = "85686f6d-1f00-4c5f-a464-54c8dbd57d40",
                            Name = "Administrator",
                            NormalizedName = "ADMINISTRATOR"
                        },
                        new
                        {
                            Id = "c668c5c0-74f4-45bd-8e77-dbf225d2a0f3",
                            Name = "Producer",
                            NormalizedName = "PRODUCER"
                        },
                        new
                        {
                            Id = "1f1bc3c8-1760-471a-be10-2f10cc868c67",
                            Name = "Organization",
            ...
            modelBuilder.Entity("EventHub.EventManagement.Domain.Entities.EventEntities.EventAttendant", b =>
                {
                    b.HasOne("EventHub.EventManagement.Domain.Entities.EventEntities.Attendant", null)
                        .WithMany()
                        .HasForeignKey("AttendantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EventHub.EventManagement.Domain.Entities.EventEntities.Event", null)
                        .WithMany()
            ...
            modelBuilder.Entity("EventHub.EventManagement.Domain.Entities.User", b =>
                {
                    b.HasOne("EventHub.EventManagement.Domain.Entities.UserPage", "UserPage")
                        .WithMany()
